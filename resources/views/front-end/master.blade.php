...
<body>
<!--header-->
@include('front-end.includes.header-content')
<!--header-->

<!-- Main Banner will be only with home. every page has its individual banner -->
<!--banner-->
@yield('main-content')
<!--content-->
<!---footer--->
@include('front-end.includes.bigFooter-content')
<!---footer--->
<!--copy-->
